...
export default function HomePage() {
  ...
  return (
    <div className="space-y-12 sm:space-y-16 py-6 sm:py-10 text-slate-900 dark:text-slate-100">
      ...
      <section className="relative pt-4 sm:pt-8 pb-8 sm:pb-12 text-center space-y-6 sm:space-y-8">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
          <Link
            href="/map"
            className="w-full sm:w-auto px-6 py-3 rounded-2xl bg-slate-800 hover:bg-slate-700 text-white font-bold text-xs sm:text-sm border border-slate-700 shadow-xl transition-all flex items-center justify-center gap-2"
          >
          ...
          <button
            ...
            className="w-full sm:w-auto px-6 py-3 rounded-2xl bg-slate-200 dark:bg-slate-800 hover:bg-slate-300 dark:hover:bg-slate-700 text-slate-900 dark:text-white font-bold text-xs sm:text-sm border border-slate-300 dark:border-slate-700 shadow-md transition-all flex items-center justify-center gap-2"
          >
        ...
        <div className="pt-6 grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 max-w-5xl mx-auto text-left">
          ...
          <div className="p-4 sm:p-5 rounded-3xl glass-card border border-slate-200 dark:border-slate-800">
            <Globe className="w-5 h-5 text-slate-600 dark:text-slate-400 mb-1.5" />
          ...
          <div className="p-4 sm:p-5 rounded-3xl glass-card border border-slate-200 dark:border-slate-800">
            <Fish className="w-5 h-5 text-emerald-500 mb-1.5" />
          ...
          <div className="p-4 sm:p-5 rounded-3xl glass-card border border-slate-200 dark:border-slate-800">
            <Radio className="w-5 h-5 text-slate-500 dark:text-slate-400 mb-1.5 animate-pulse" />
            <span className="text-xl sm:text-3xl font-extrabold text-slate-900 dark:text-white font-mono block">14</span>
      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          {oceanSectors.slice(0, 6).map((sector) => (
            <div
              key={sector.id}
              className="p-5 sm:p-6 rounded-3xl glass-panel border border-slate-200 dark:border-slate-800 space-y-4 hover:border-slate-500 transition-all"
            >
      ...
      <section className="space-y-6">
        <div className="p-6 sm:p-10 rounded-3xl glass-panel border border-slate-300 dark:border-slate-800 space-y-6 sm:space-y-8">
